import { ddv, dlv, dsv } from '#utils/object/index.ts';
import { hash } from '#utils/string/index.ts';
import { atom, type WritableAtom } from 'nanostores';

const IS_PROD = !!(
    (typeof __IS_PROD__ !== 'undefined' && __IS_PROD__) ||
    (typeof import.meta.env === 'object' && import.meta.env?.MODE === 'production')
);
const TIMESTAMP = (typeof __TIMESTAMP__ !== 'undefined' && __TIMESTAMP__) || '';
const DEBUG = !!(
    (typeof __DEBUG__ !== 'undefined' && __DEBUG__) ||
    (typeof import.meta.env === 'object' && import.meta.env?.MODE === 'development')
);
